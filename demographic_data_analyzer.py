...
def calculate_demographic_data(print_data=True):
    ...
    percentage_bachelors = round(bachelor_degree.shape[0] / df.shape[0] * 100, 1)
    ...
    Indians_rich = df[(df['salary'] == '>50K') & (df['native-country'] == 'India')]
    top_IN_occupation = Indians_rich['occupation'].mode()[0]
